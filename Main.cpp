...
void* cross_bridge(void* arg) {
    ...
    printf("Vehículo tipo %c ha entrado en el puente en dirección %c.\n", vehicle->type, (vehicle->type == 'E') ? 'E' : 'W');
    ...
    pthread_mutex_lock(&bridge.mutex);
    bridge.is_busy = 0;
    printf("Vehículo tipo %c ha salido del puente en dirección %c.\n", vehicle->type, (vehicle->type == 'E') ? 'E' : 'W');
    pthread_mutex_unlock(&bridge.mutex);
...
int main() {
    ...
    char vehicle_types[MAX_VEHICLES] = {'E', 'W', 'E', 'W', 'E', 'W', 'E', 'W', 'E', 'W', 'E', 'W', 'E', 'W', 'E', 'W', 'E', 'W', 'E', 'W'};
    ...
    for (int i = 0; i < MAX_VEHICLES; i++) {
        ...
        vehicle->speed = rand() % 3 + 1; // Velocidad aleatoria entre 1 y 3 segundos
